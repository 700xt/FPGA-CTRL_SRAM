...
begin
    ...
    begin
        ...
        -- burst WRITE @2
        usr_addr_s <= std_logic_vector(shift_left(unsigned(usr_addr_s), 1));
        ...
        -- burst WRITE @4
        usr_addr_s <= std_logic_vector(shift_left(unsigned(usr_addr_s), 1));
        usr_data_in_s <= x"BEEF0004";
        wait for CLK_PERIOD;
        
        -- burst WRITE @8
        usr_addr_s <= std_logic_vector(shift_left(unsigned(usr_addr_s), 1));
        usr_data_in_s <= x"BEEF0008";
        wait for CLK_PERIOD;

        -- burst WRITE @16
        usr_addr_s <= std_logic_vector(shift_left(unsigned(usr_addr_s), 1));
        usr_data_in_s <= x"BEEF0016";
        wait for CLK_PERIOD;
